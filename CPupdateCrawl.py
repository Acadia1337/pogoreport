...
crawl_pokemonInfo("386/attack")
crawl_pokemonInfo("386/defense")
crawl_pokemonInfo("386/normal")
crawl_pokemonInfo("386/speed")


crawl_pokemonInfo("413/plant")
crawl_pokemonInfo("413/sandy")
crawl_pokemonInfo("413/trash")


crawl_pokemonInfo("421/Overcast")
crawl_pokemonInfo("421/Sunny")

crawl_pokemonInfo("422/East Sea")
crawl_pokemonInfo("422/West Sea")
crawl_pokemonInfo("423/East Sea")
crawl_pokemonInfo("423/West Sea")

crawl_pokemonInfo("479")
crawl_pokemonInfo("479/Fan")
crawl_pokemonInfo("479/Frost")
crawl_pokemonInfo("479/Heat")
crawl_pokemonInfo("479/Mow")
crawl_pokemonInfo("479/Wash")
'''
crawl_pokemonInfo("487/Altered")
crawl_pokemonInfo("487/Origin")

crawl_pokemonInfo("492/Land")
crawl_pokemonInfo("492/Sky")
...
#151,뮤,에스퍼,NONE,210,210,225,33,1399,1865,2332,2799,3032,3265,20 km,10000%,0%,섀도크루,12.9,솔라빔,36.7,볼트체인지,8.7,솔라빔,36.7
